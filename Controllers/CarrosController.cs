...
namespace Desafio_Loja_de_Carros.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(Desafio_Loja_de_CarrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carro != null ? 
                          ...
                          Problem("Entity set 'Desafio_Loja_de_CarrosContext.Carro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Desafio_Loja_de_CarrosContext.Carro'  is null.");
            }
            var carro = await _context.Carro.FindAsync(id);
            if (carro != null)
            {
